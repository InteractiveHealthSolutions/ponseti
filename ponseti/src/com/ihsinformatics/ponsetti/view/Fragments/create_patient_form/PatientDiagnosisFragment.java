...
public class PatientDiagnosisFragment extends MyFragment implements OnCheckedChangeListener {
	...
	public List<Answer> getAnswers(int formId) {
		...
		addCheckBoxesAnswers(CreatePatient.QUESTION_TYPE_OF_PREVIOUS_TREATMENTS, formId, cbCastingAboveKnee, cbCastingBelowKnee, cbPhysiotherapy, cbUnspecified, cbOther);
				...
				if (ans != null && !"null".equals(ans)) {
					if (questionId == CreatePatient.QUESTION_NAME_OF_EVALUATOR) {
						...
						etNumberOfPreviuosTreatments.setText(ans);
							...
							if(cbCastingAboveKnee.getText().toString().equals(ans)) {
								cbCastingAboveKnee.setChecked(true);
							} else if(cbCastingBelowKnee.getText().toString().equals(ans)) {
								cbCastingBelowKnee.setChecked(true);
							} else if(cbPhysiotherapy.getText().toString().equals(ans)) {
								cbPhysiotherapy.setChecked(true);
							} else if(cbOther.getText().toString().equals(ans)) {
								cbOther.setChecked(true);
							} else if(cbUnspecified.getText().toString().equals(ans)) {
